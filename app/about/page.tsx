          ...
          <section className="space-y-4">
            ...
            <div className="space-y-4 text-base leading-relaxed text-zinc-600 dark:text-zinc-400">
              ...
              <p>
                ...
                ? That&apos;s the shape{" "}
                <span className="font-medium text-zinc-800 dark:text-zinc-200">learnwithme</span>{" "}
                is trying out.
              </p>
              <p>
          ...
          <section className="space-y-4">
            ...
            <div className="space-y-4 text-base leading-relaxed text-zinc-600 dark:text-zinc-400">
              <p>
                ...
                <span className="font-medium text-zinc-800 dark:text-zinc-200">YouTube</span>{" "}
              ...
              <p>
                ...
                <span className="font-medium text-zinc-800 dark:text-zinc-200">learnwithme </span> is
              ...
              <p>
                ...
                this sits{" "}
                <strong className="font-medium text-zinc-800 dark:text-zinc-200">alongside</strong>{" "}
